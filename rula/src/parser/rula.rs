...
// sha3: 169697db99c9aba9074498da5ac027cfd21c2bee93f6dfc893b951e35f6c2faf
...
#[allow(unused_variables)]
fn __action3<'input>(input: &'input str, (_, __0, _): (usize, &'input str, usize)) -> OpCode {
    OpCode::Add
}

#[allow(unused_variables)]
fn __action4<'input>(input: &'input str, (_, __0, _): (usize, &'input str, usize)) -> OpCode {
    OpCode::Sub
}
...
#[allow(unused_variables)]
fn __action6<'input>(input: &'input str, (_, __0, _): (usize, Box<Expr>, usize)) -> Box<Expr> {
    __0
}

#[allow(unused_variables)]
fn __action7<'input>(input: &'input str, (_, __0, _): (usize, &'input str, usize)) -> OpCode {
    OpCode::Mul
}

#[allow(unused_variables)]
fn __action8<'input>(input: &'input str, (_, __0, _): (usize, &'input str, usize)) -> OpCode {
    OpCode::Div
}

#[allow(unused_variables)]
fn __action9<'input>(input: &'input str, (_, __0, _): (usize, i32, usize)) -> Box<Expr> {
